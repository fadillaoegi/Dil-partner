...
List<UserProfile> dataProfile = [
  UserProfile(
      ...
      imagePath: "${DilAssetManager.asset}/people_love1_image"),
  UserProfile(
      fullname: "Shofa",
      occupation: "Designer",
      age: 21,
      decription: "Stay Foolish and i will make dream come true",
      imagePath: "${DilAssetManager.asset}/people_love2_image"),
  UserProfile(
      fullname: "Nabila",
      occupation: "Mobile Dev",
      age: 22,
      decription: "Stay Foolish and i will make dream come true",
      imagePath: "${DilAssetManager.asset}/people_love3_image"),
];
